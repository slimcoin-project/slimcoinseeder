...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Slimcoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.shitcoinrapist.club", "dnsseed.furiousnomad.com", ""};
static const string testnet_seeds[] = {"testnet-seed.shitcoinrapist.club", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 41682), true);
  }
  do {
